...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", required=True, help="Skill name (1-64 chars, lowercase, hyphens)")
    parser.add_argument("--description", required=True, help="Skill description (max 1024 chars)")
